...
public class CouponDao {
	...
	public Long createCoupon(CouponEntity coupon) throws ApplicationException {
		try {
			...
			Query query = entityManager.createQuery("SELECT coupon.couponId FROM CouponEntity as coupon WHERE coupon =:coupon");
	...
	public void deleteCoupon(long couponId) throws ApplicationException {
		...
		//	List<CouponCustomerEntity> couponCustomer = getCouponCustomerByCouponId(couponId);
			try {
...
//	@Transactional(propagation = Propagation.REQUIRED)
//	public CouponCustomerEntity getCouponCustomerByCouponId(Long couponId) throws ApplicationException {
//		try {
...
//	}
	...
	public void deleteCouponsByCompany(long companyId) throws ApplicationException {		
		try {
			...
			throw new ApplicationException(e, ErrorType.SYSTEM_ERROR, "Error in couponDao, deleteCoupopnByCompany(); Failed");
		}
	}
...
//			entityManager.remove(coupon);
//		} catch (Exception e) {
//			throw new ApplicationException(e, ErrorType.SYSTEM_ERROR, "Error in couponDao, deleteCouponsByEndDate(); Failed");
//		}
//	}
	...
	public List<CouponEntity> getCouponByCouponType(CouponType couponType) throws ApplicationException {
		...
		try {
			Query query = entityManager.createQuery("SELECT coupon FROM CouponEntity As coupon WHERE couponType =:couponType");
			query.setParameter("couponType", couponType);
			couponList = query.getResultList();
		}

		catch (Exception e) {
			throw new ApplicationException(e, ErrorType.SYSTEM_ERROR, "Error in couponDao, getCouponByCouponType(); Failed");
		}
		return couponList;
	}
	...
	try {
		Query query = entityManager.createQuery("SELECT coupon FROM CouponEntity As coupon WHERE couponPrice <=:couponPrice");
	...
	public List<CouponEntity> getCouponUpToDate(String couponEndDate) throws ApplicationException {
		...
		try {
			Query query = entityManager.createQuery("SELECT coupon FROM CouponEntity As coupon WHERE couponEndDate <=:couponEndDate");
			query.setParameter("couponEndDate", couponEndDate);
			couponList = query.getResultList();
		}

		catch (Exception e) {
			throw new ApplicationException(e, ErrorType.SYSTEM_ERROR, "Error in couponDao, getCouponUpToDate(); Failed");
		}
		return couponList;
	}
	...
	public List<CouponEntity> getAllExpiredCoupons() throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.SYSTEM_ERROR, "Error in couponDao, getAllExpiredCoupons(); Failed");
		}
		return couponList;
	}
	...
	public void deleteCouponsByEndDate(String couponEndDate) throws ApplicationException {
		try {
			Query query = entityManager.createQuery("DELETE FROM CouponEntity AS coupon WHERE couponEndDate <=:couponEndDate");
			query.setParameter("couponEndDate", couponEndDate);
			query.executeUpdate();
...
//		Coupon coupon = null;
//		List<Coupon> allExpiredCoupons = new ArrayList<Coupon>();
//
//		try {
...
//	}
	...
	try {
		Query query = entityManager.createQuery("SELECT coupon FROM CouponEntity As coupon WHERE customerId =:customerId ");
	...
	public ArrayList<CouponEntity> getCouponByCompanyId(long companyId) throws ApplicationException {
		...
		try {
			Query query = entityManager.createQuery("SELECT coupon FROM CouponEntity As coupon WHERE companyId =:companyId ");
			query.setParameter("companyId", companyId);
	...
	public boolean isCouponExistByTitle(String couponTitle) throws ApplicationException {		
		try {
			Query query = entityManager.createQuery("SELECT coupon FROM CouponEntity As coupon WHERE couponTitle =:couponTitle");
